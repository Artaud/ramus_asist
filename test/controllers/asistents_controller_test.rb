...
class AsistentsControllerTest < ActionController::TestCase
  ...
  test "should create asistent" do
    assert_difference('Asistent.count') do
      post :create, asistent: { email: @asistent.email, jmeno: @asistent.jmeno, prijmeni: @asistent.prijmeni, telefon: @asistent.telefon }
    end
  ...
  test "should update asistent" do
    patch :update, id: @asistent, asistent: { email: @asistent.email, jmeno: @asistent.jmeno, prijmeni: @asistent.prijmeni, telefon: @asistent.telefon }
    assert_redirected_to asistent_path(assigns(:asistent))
  end
